...
Cabe mencionar que podemos nosotros utilizar diversos medios para poder realizar nuestras aplicaciones en .NET como son:

- La interfaz de línea de comandos de .NET (CLI)
- Utilizando Visual Studio (Windows / Mac)
...
Para comprobar si la CLI está instalada correctamente abriendo el símbolo del sistema en Windows y escribiendo dotnet y pulsando Enter. Si muestra el uso y la ayuda como se muestra en la imagen, significa que está instalado correctamente.

<img src="{{ site.github.url }}/assets/img/{{ page.image }}" alt="DotNet CLI">
